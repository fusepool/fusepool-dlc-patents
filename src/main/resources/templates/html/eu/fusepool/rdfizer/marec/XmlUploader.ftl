...
<html>
  ...
  <body>
    ...
    <form method="POST" action="<@ldpath path="."/>" accept-charset="utf-8" enctype="multipart/form-data">
    
        <label for="file">Document to transform</label><input type="file" name="file" size="90"/><br/>
        <label for="mime_type">MIME type</label><input type="text" name="mime_type" size="30"/><br/>
        <input type="submit" value="RDFize" />
